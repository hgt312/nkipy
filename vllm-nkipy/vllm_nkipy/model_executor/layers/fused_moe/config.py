...
# Adapted from vLLM (https://github.com/vllm-project/vllm/tree/main/vllm/model_executor/layers/fused_moe)
...
def _get_quant_config_quantization_args(
    ...
    if (
        ...
        and hasattr(quant_config, "target_scheme_map")
        and "Linear" in quant_config.target_scheme_map
        and "input_activations" in quant_config.target_scheme_map["Linear"]
    ):
