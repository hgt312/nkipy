...
class TestAtenAdd(NKIPyTestBase):
    ...
    def test_add_tensor_shapes_dtypes(self, shape1, shape2, dtype):
        """Test aten.add.Tensor with different shapes and dtypes."""
    ...
    def test_add_tensor_alpha(self, alpha):
        """Test aten.add.Tensor with different alpha values."""

        def test_func(a, b, alpha=alpha):
            return torch.ops.aten.add.Tensor(a, b, alpha=alpha)
    ...
    def test_add_tensor_scalar(self):
        """Test aten.add.Tensor with scalar values."""
