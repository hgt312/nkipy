...
class TestAtenGeTensor(NKIPyTestBase):
    ...
    def test_ge_tensor_shapes_dtypes(self, shape, dtype):
        """Test aten.ge.Tensor with different shapes and dtypes."""

        def test_func(x, y):
            return torch.ops.aten.ge.Tensor(x, y)
    ...
    def test_ge_tensor_broadcasting(self):
        """Test ge.Tensor with broadcasting."""
    ...
    def test_ge_tensor_special_values(self):
        """Test ge.Tensor with special values."""
    ...
    def test_ge_tensor_edge_cases(self):
        """Test ge.Tensor with edge cases."""
