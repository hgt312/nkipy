...
class TestAtenCumprod(NKIPyTestBase):
    ...
    def test_cumprod_shapes_dtypes(self, shape, dim, dtype):
        """Test aten.cumprod.default with different shapes and dtypes."""

        def test_func(x):
            return torch.ops.aten.cumprod.default(x, dim)
    ...
    def test_cumprod_special_values(self):
        """Test cumprod.default with special values."""

        def test_func(x):
            return torch.ops.aten.cumprod.default(x, 0)
    ...
    def test_cumprod_edge_cases(self):
        """Test cumprod.default with edge cases."""
